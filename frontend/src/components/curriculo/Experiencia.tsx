export default function Experiencia() {
	return (
		<div className="flex flex-col sm:flex-row lg:flex-col items-center justify-around gap-6 bg-black border border-zinc-800 rounded-2xl p-6">
			<Item principal="+150" label="paises atentidos" />
